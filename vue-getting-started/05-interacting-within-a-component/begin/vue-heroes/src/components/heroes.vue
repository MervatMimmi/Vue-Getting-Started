...
const inputeDateFormat = 'YYYY-MM-DD';
...
const ourHeroes = [
  {
    ...
    lastName: 'Papa',
    capeCounter: 3,
    originDate: format(new Date(1996, 5, 1), inputeDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 1,
    originDate: format(new Date(1998, 7, 1), inputeDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 2,
    originDate: format(new Date(1999, 8, 1), inputeDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 0,
    originDate: format(new Date(2000, 9, 1), inputeDateFormat),
